...
# train-lwp
# 2018.12.4约11：00->18：30
# mAP: 0.9418 rank1: 0.9587 rank3: 0.9748 rank5: 0.9798 rank10: 0.9843 (Best: 0.9418 @epoch 400)
#CUDA_VISIBLE_DEVICES=0 python main.py --datadir /home/abcd/Downloads/Market-1501-v15.09.15/ --batchid 8 --#batchtest 16 --test_every 50 --epochs 400 --decay_type step_320_380 --loss 1*CrossEntropy+2*Triplet --margin 1.2 --#save adam_1 --nGPU 1 --lr 2e-4 --optimizer ADAM --random_erasing --reset --re_rank --amsgrad
CUDA_VISIBLE_DEVICES=0 python main.py --datadir /home/disk2/homedepot/clean-data/2018-09-14/2018-09-14/Market-1501-v15.09.15/ --batchid 8 --batchtest 16 --test_every 50 --epochs 400 --decay_type step_320_380 --loss 1*CrossEntropy+2*Triplet --margin 1.2 --save adam_1 --nGPU 1 --lr 2e-4 --optimizer ADAM --random_erasing --reset --re_rank --amsgrad --num_classes 1142
