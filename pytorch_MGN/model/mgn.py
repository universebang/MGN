...
class MGN(nn.Module):
    def __init__(self, args):
        ...
        res_p_conv5 = nn.Sequential(
            ...
            Bottleneck(2048, 512),
            Bottleneck(2048, 512))
        res_p_conv5.load_state_dict(resnet.layer4.state_dict())#load weight
        ...
        self.fc_id_2048_0 = nn.Linear(args.feats, num_classes)#Applies a linear transformation to the incoming data:
